...
- интерфейс на русском и казахском, светлая и тёмная тема — выбор запоминается
  в браузере. Содержимое сайта из CMS и наименования справочников хранятся на
  том языке, на котором их завели.
...
Сайт и API разворачиваются двумя проектами Vercel из этого репозитория —
конфиги лежат рядом с кодом. Что нужно завести из инфраструктуры, какие
переменные выставить и как накатывать миграции, описано в [DEPLOY.md](DEPLOY.md).
